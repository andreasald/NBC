...
namespace iNBC
{
    public partial class TambahJadwalDokter : UserControl
    {
        public TambahJadwalDokter()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e) // Button Simpan
        {
            if (flagperintah == 1)//tambah data
            {
                ...
                if (cektxt() == true)
                {
                    ...
                    int IDPeg = JDWL_C.getIdPegawai(cmbNamaDKTR.Text);
            ...
            else 
            {
                ...
                if (cektxt() == true)
                {
                    ...
                    iNBC.Entity.PegawaixShift PxS = new Entity.PegawaixShift(IDPeg, IDShift); 
                    DialogResult dr = MessageBox.Show("Apakah anda yakin ingin mengubah data jadwal " + temp_promo, "iNBC",
        ...
        private bool cektxt()
        {
            ...
            if (cmbNamaDKTR.SelectedIndex == -1)
            {
                errorProvider1.SetError(cmbHari, "silahkan pilih Hari");
                cmbHari.Focus();
                temp = false;
            }
        ...
        {
            cmbNamaDKTR.DataSource = JDWL_C.getNamaDokter();
            cmbNamaDKTR.DisplayMember = "NAMAPGW";
